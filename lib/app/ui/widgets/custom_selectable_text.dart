...
import 'package:reikodev_website/app/ui/utils/action_intent.dart';

import 'package:reikodev_website/app/ui/utils/mouse_preventer/mouse_click_preventer_io_impl.dart'
    if (dart.library.html) 'package:reikodev_website/app/ui/utils/mouse_preventer/mouse_click_preventer_web_impl.dart';
...
class _CustomSelectableTextState extends State<CustomSelectableText> {
  ...
  void _onPanStart(DragStartDetails details) {
    if (_renderParagraph == null || !mounted) return;
  ...
  void _onPanUpdate(DragUpdateDetails details) {
    ...
    try {
      ...
      if (selectionExtentOffset == null) return;
